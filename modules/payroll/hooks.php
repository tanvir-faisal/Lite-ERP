...
class payroll_app extends application
{
		...
		global $path_to_root;
                ...
                $this->add_lapp_function(3, _("&List Of Employees"),
                        $path_to_root.'/modules/ITLink/index.php', 'SA_PAYROLL', MENU_MAINTENANCE);
                $this->add_lapp_function(3, _("&Attendance Of Employees"),
                        $path_to_root.'/modules/ITLink/attn/index.php', 'SA_PAYROLL', MENU_MAINTENANCE);
